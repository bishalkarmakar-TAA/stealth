...
# print(f" ENGINE STARTING... GOOGLE_KEY exists", flush=True)
...
#     start_p = fetch_google_aqi_profile(data.start_loc.lat, data.start_loc.lon)
#     end_p = fetch_google_aqi_profile(data.end_loc.lat, data.end_loc.lon)
...
#     """Java will call this to get the next 12 hours
#     for this, we simulate a 24 hours dataset and return the next 12 hours from it."""
